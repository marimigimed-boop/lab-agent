"""
Поиск писем конкретного пациента в папке ЛАБОРАТОРИЯ ДИАЛАБ (МОЙ МЕД),
...
from src.utils.word_builder import build_multi_patient_word_bytes, build_email_with_word
...
def find_and_send(patient_name_fragment: str, since_date: str | None = None) -> None:
    ...
    subject  = (
        f"Интерпретация анализов — {patient_name_fragment} "
...
if __name__ == "__main__":
    ...
    if not patient:
        print("Укажите фамилию пациента: python find_patient.py \"Иглина\"")
        sys.exit(1)
